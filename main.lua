...
-- // Sounds
-- NOTE: replace these asset IDs with sounds you own or have permission to use.
-- Toolbox > Audio is a good place to find free UI chime / whoosh sfx.
...
-- // Tween infos
-- Entrance shortened back to a snappy splash-screen pace. 6s was only
-- ever meant for something with real multi-second work behind it.
...
-- // Continuous cog spin (looping tween, no polling loop)
